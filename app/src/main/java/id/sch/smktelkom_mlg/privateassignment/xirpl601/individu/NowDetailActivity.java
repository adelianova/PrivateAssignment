...
public class NowDetailActivity extends AppCompatActivity {

    private static final String URL_DATA = "https://api.themoviedb.org/3/movie/now_playing?api_key=2205bfc7dacc798b8638acb44502f25b&language=en-US&page=1";
    ...
    private void loadRecyclerViewData() {
        ...
        progressDialog.setMessage("Please Wait ya...");
        progressDialog.show();
